        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-4 w-full sm:w-auto">
              <button className="flex items-center justify-center gap-2 px-8 py-4 bg-brand-cyan text-brand-dark font-semibold rounded-full hover:bg-white transition-all hover:-translate-y-[2px] active:scale-[0.98]">
                <span>Inicie um Projeto</span>
                <ArrowRight size={20} weight="bold" />
              </button>
              <button className="flex items-center justify-center gap-2 px-8 py-4 bg-transparent border border-white/20 text-white font-medium rounded-full hover:bg-white/5 transition-all hover:-translate-y-[2px] active:scale-[0.98]">
                Nossos Casos de Uso
              </button>
            </div>
          </motion.div>
